*> \brief \b DTRTRMM_WORK computes an in place triangular-triangular matrix product
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*     RECURSIVE SUBROUTINE DTRTRMM_WORK(SIDE, UPLO, TRANSV, DIAGT, DIAGV,
*    $                        N, ALPHA, T, LDT, V, LDV, work, ldwork)
*
*        .. Scalar Arguments ..
*        INTEGER           N, LDT, LDV
...
*> \verbatim
*>
*> DTRTRMM_WORK performs one  of the matrix-matrix operations
*>
*>       T = \alpha op(V) * T
*>                      or
*>       T = \alpha T * op(V)
...
*> \verbatim
*>          ldwork is Integer
*>             On entry, ldwork specifies the first dimension of
*>             work as declared in the calling (sub) program, ldwork
*>             must be at least max(1,n-floor(n/2))
*> \endverbatim
! TODO: Move the work declaration to trtrmm NOT trtrsm
*
*  Authors:
*  ========
*
...
c     Cost: 2/21 * (3n^3 + 7n^2 - 10) + 2
      RECURSIVE SUBROUTINE DTRTRMM_WORK(SIDE, UPLO, TRANSV, DIAGT,
     $                  DIAGV, N, ALPHA, T, LDT, V, LDV, WORK, LDWORK)
*
*        .. Scalar Arguments ..
         INTEGER           N, LDT, LDV, LDWORK
         CHARACTER         SIDE, UPLO, TRANSV, DIAGT, DIAGV
         DOUBLE PRECISION  ALPHA
*        ..
*        .. Array Arguments ..
         DOUBLE PRECISION  T(LDT,*), V(LDV,*), WORK(LDWORK,*)
*        ..
*
*  =====================================================================
*
...
*
         CALL DTRTRMM_WORK(SIDE, UPLO, TRANSV, DIAGT, DIAGV, K, ALPHA,
     $         T, LDT, V, LDV)
*
*        Compute T_{22} recursively
*
         CALL DTRTRMM_WORK(SIDE, UPLO, TRANSV, DIAGT, DIAGV, N-K, ALPHA,
