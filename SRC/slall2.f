*> \brief \b SLALL2 computes the product LLH or UHU, where U and L are upper or lower triangular matrices (unblocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE SLALL2( UPLO, N, A, LDA, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> SLALL2 computes the product L * L**H or U**H * U, where the triangular
      ...
      ELSE
         ...
         DO J = N, 1, -1
            ...
            IF( J.EQ.1 ) THEN
               ...
               CALL SSCAL(N, AJJ, A, 1)
            ELSE
               ! complex version will need {c,z}gemm since the vector x is
               ! conjugated (or a {c,z}gemcv-like statement)
               CALL SGEMV('No Transpose', N-J+1, J-1, ONE,
