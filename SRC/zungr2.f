*> \brief \b ZUNGR2 generates all or part of the orthogonal matrix Q from an RQ factorization determined by zgerqf (unblocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
*  Definition:
...
*
      IF( M.LE.0 ) THEN
         RETURN
      ELSE IF( K.LE.0 ) THEN
         CALL ZLASET('All', M, N, ZERO, ONE, A(1,M-N+1), LDA)
         RETURN
      END IF
*
