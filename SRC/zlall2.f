*> \brief \b ZLALL2 computes the product LLH or UHU, where U and L are upper or lower triangular matrices (unblocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE ZLALL2( UPLO, N, A, LDA, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> ZLALL2 computes the product L * L**H or U**H * U, where the triangular
