*> \brief \b CTRTRMM computes an in place triangular-triangular matrix product
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*     RECURSIVE SUBROUTINE CTRTRMM(SIDE, UPLO, TRANSV, DIAGT, DIAGV,
*    $                        N, ALPHA, T, LDT, V, LDV)
*
*        .. Scalar Arguments ..
*        INTEGER           N, LDT, LDV
...
*> \verbatim
*>
*> CTRTRMM performs one  of the matrix-matrix operations
*>
*>       T = \alpha op(V) * T
*>                      or
*>       T = \alpha T * op(V)
...
*
      CALL CTRTRMM(SIDE, UPLO, TRANSV, DIAGT, DIAGV, K, ALPHA,
     $      T, LDT, V, LDV)
*
*     Compute T_{22} recursively
*
      CALL CTRTRMM(SIDE, UPLO, TRANSV, DIAGT, DIAGV, N-K, ALPHA,
