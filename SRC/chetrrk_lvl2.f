...
*
               IF(UNITT) THEN
                  IF (BETA.EQ.ZERO) THEN
                     DO I = 1, K
                        CALL CTRMVOOP(UPLOA, 'Transpose', DIAG, I-1,
...
*
     ...
     $                     + BETA*C(I,I)
               ...
               ELSE
                  DO I = 1, K
                     CALL CTRMVOOP(UPLOA, 'Transpose', DIAG, I,
     $                     ALPHA, A, LDA, A(1,I), 1, BETA, C(1,I), 1)
                  END DO
               END IF
            ELSE
...
*
               IF(UNITT) THEN
                  IF (BETA.EQ.ZERO) THEN
                     DO I = 1, K
                        CALL CTRMVOOP(UPLOA, 'Transpose', DIAG, K-I,
...
*
     ...
     $                     ONE) + BETA*C(I,I)
               ...
               ELSE
                  DO I = 1, K
                     CALL CTRMVOOP(UPLOA, 'Transpose', DIAG, K-I+1,
