*> \brief \b DLALLM computes the product LLH or UHU, where U and L are upper or lower triangular matrices (blocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DLALLM( UPLO, N, A, LDA, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> DLALLM computes the product L * L**H or U**H * U, where the triangular
...
*
*  =====================================================================
      SUBROUTINE DLALLM_BLOCKED( UPLO, N, A, LDA, INFO )
      IMPLICIT NONE
*
...
*              memory and dgemm promises to do nothing when
...
*
            CALL DLALL2('Upper', IB, A(I,I), LDA, INFO)
*
*           Update the diagonal block with the part of A above the diagonal
*
            CALL DSYRK('Upper', 'Transpose', IB, I-1,
...
*           Now, we update the diagonal block of interest
*
            CALL DLALL2('Lower', IB, A(I,I), LDA, INFO)
*
*           Update the diagonal block with the part of A above the diagonal
*
            CALL DSYRK('Lower', 'No Transpose', IB, I-1,
