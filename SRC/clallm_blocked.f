*> \brief \b CLALLM computes the product LLH or UHU, where U and L are upper or lower triangular matrices (blocked algorithm).
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE CLALLM( UPLO, N, A, LDA, INFO )
*
*       .. Scalar Arguments ..
*       CHARACTER          UPLO
*       INTEGER            INFO, LDA, N
...
*> \verbatim
*>
*> CLALLM computes the product L * L**H or U**H * U, where the triangular
...
*
*  =====================================================================
      SUBROUTINE CLALLM_BLOCKED( UPLO, N, A, LDA, INFO )
      IMPLICIT NONE
*
...
*
               CALL CTRMM('Left', 'Upper', 'Conjguate', 'Non-Unit',
...
*              memory and cgemm promises to do nothing when
*              any input dimension is 0, we don't have to guard here
*
               CALL CGEMM('Conjguate', 'No Transpose',
     $            IB, N-(I+IB)+1, I-1,
...
*
            CALL CLALL2('Upper', IB, A(I,I), LDA, INFO)
*
*           Update the diagonal block with the part of A above the diagonal
*
            CALL CHERK('Upper', 'Conjguate', IB, I-1,
...
*              We guard this to prevent potentially referencing invalid memory
*
               CALL CTRMM('Right', 'Lower', 'Conjguate', 'Non-Unit',
...
*              any input dimension is 0, we don't have to guard here
*
               CALL CGEMM('No Transpose', 'Conjguate',
     $            N-(I+IB)+1, IB, I-1,
...
*           Now, we update the diagonal block of interest
*
            CALL CLALL2('Lower', IB, A(I,I), LDA, INFO)
*
*           Update the diagonal block with the part of A above the diagonal
*
            CALL CHERK('Lower', 'No Transpose', IB, I-1,
