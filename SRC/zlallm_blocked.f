...
*
*  =====================================================================
      SUBROUTINE ZLALLM_BLOCKED( UPLO, N, A, LDA, INFO )
      IMPLICIT NONE
*
...
*
               CALL ZTRMM('Left', 'Upper', 'Conjguate', 'Non-Unit',
...
*              memory and zgemm promises to do nothing when
*              any input dimension is 0, we don't have to guard here
*
               CALL ZGEMM('Conjguate', 'No Transpose',
     $            IB, N-(I+IB)+1, I-1,
...
*
            CALL ZLALL2('Upper', IB, A(I,I), LDA, INFO)
*
*           Update the diagonal block with the part of A above the diagonal
*
            CALL ZHERK('Upper', 'Conjguate', IB, I-1,
...
*              We guard this to prevent potentially referencing invalid memory
*
               CALL ZTRMM('Right', 'Lower', 'Conjguate', 'Non-Unit',
...
*              any input dimension is 0, we don't have to guard here
*
               CALL ZGEMM('No Transpose', 'Conjguate',
     $            N-(I+IB)+1, IB, I-1,
...
*           Now, we update the diagonal block of interest
*
            CALL ZLALL2('Lower', IB, A(I,I), LDA, INFO)
*
*           Update the diagonal block with the part of A above the diagonal
*
            CALL ZHERK('Lower', 'No Transpose', IB, I-1,
