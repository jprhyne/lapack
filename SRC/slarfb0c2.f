...
*  ===========
*
*     SUBROUTINE SLARFB0C2(C2JOB, APPLYT, SIDE, TRANS, DIRECT,
...
*
         IF (TRANST) THEN
            IF (TSOLVE) THEN
               CALL STRSM('Right', 'Upper', 'Transpose',
     ...
     $               'Non-unit', M, K, ONE, T, LDT, C, LDC)
         ...
         ELSE
            IF (TSOLVE) THEN
               CALL STRSM('Right', 'Lower', 'No Transpose',
     $               'Non-unit', M, K, ONE, T, LDT, C, LDC)
            ELSE
...
*
         IF (TSOLVE) THEN
            CALL STRSM('Left', 'Lower', 'No Transpose', 'Non-unit',
...
*
     ...
     $            'Non-unit', M, K, ONE, T, LDT, C(1, N-K+1), LDC)
         ...
         ELSE
            IF (TSOLVE) THEN
               CALL STRSM('Right', 'Upper', 'No Transpose',
     $            'Non-unit', M, K, ONE, T, LDT, C(1, N-K+1), LDC)
            ELSE
